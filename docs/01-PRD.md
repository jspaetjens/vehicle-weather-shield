...
- [3. Goals](#3-goals)
- [4. Scope](#4-scope)
  - [In Scope (Version 1.0)](#in-scope-version-10)
  - [Out of Scope (Version 1.0)](#out-of-scope-version-10)
  - [Future Vision](#future-vision)
- [5. Stakeholders](#5-stakeholders)
- [6. Functional Requirements](#6-functional-requirements)
  - [Weather Detection](#weather-detection)
    - [FR-001 Hail Detection](#fr-001-hail-detection)
    - [FR-002 Weather Risk Assessment](#fr-002-weather-risk-assessment)
    - [FR-003 Weather Provider Architecture](#fr-003-weather-provider-architecture)
  - [Vehicle Integration](#vehicle-integration)
    - [FR-004 Tesla Presence Detection](#fr-004-tesla-presence-detection)
    - [FR-005 Vehicle Exposure Assessment](#fr-005-vehicle-exposure-assessment)
  - [Notifications](#notifications)
    - [FR-006 Early Warning Notifications](#fr-006-early-warning-notifications)
    - [FR-007 Notification Severity](#fr-007-notification-severity)
  - [Home Assistant Integration](#home-assistant-integration)
    - [FR-008 Home Assistant Entities](#fr-008-home-assistant-entities)
    - [FR-009 Home Assistant Automations](#fr-009-home-assistant-automations)
    - [FR-010 Configuration Flow](#fr-010-configuration-flow)
  - [Distribution](#distribution)
    - [FR-011 HACS Installation](#fr-011-hacs-installation)
    - [FR-012 Automatic Updates](#fr-012-automatic-updates)
    - [FR-013 Integration Health](#fr-013-integration-health)
- [7. Non Functional Requirements](#7-non-functional-requirements)
  - [Reliability](#reliability)
    - [NFR-001 Service Availability](#nfr-001-service-availability)
    - [NFR-002 Operational Health Monitoring](#nfr-002-operational-health-monitoring)
    - [NFR-003 Fault Tolerance](#nfr-003-fault-tolerance)
  - [Performance Efficiency](#performance-efficiency)
    - [NFR-004 Efficient Resource Usage](#nfr-004-efficient-resource-usage)
    - [NFR-005 Efficient Data Retrieval](#nfr-005-efficient-data-retrieval)
  - [Security](#security)
    - [NFR-006 Secure Credential Handling](#nfr-006-secure-credential-handling)
    - [NFR-007 Secure Communication](#nfr-007-secure-communication)
  - [Maintainability](#maintainability)
    - [NFR-008 Modular Design](#nfr-008-modular-design)
    - [NFR-009 Code Maintainability](#nfr-009-code-maintainability)
  - [Testability](#testability)
    - [NFR-010 Automated Testing](#nfr-010-automated-testing)
    - [NFR-011 Continuous Integration](#nfr-011-continuous-integration)
  - [Usability](#usability)
    - [NFR-012 Ease of Installation](#nfr-012-ease-of-installation)
    - [NFR-013 User Feedback](#nfr-013-user-feedback)
  - [Documentation](#documentation)
    - [NFR-014 Project Documentation](#nfr-014-project-documentation)
    - [NFR-015 Developer Documentation](#nfr-015-developer-documentation)
- [8. Use Cases](#8-use-cases)
  - [UC-001 – Early Hail Warning](#uc-001--early-hail-warning)
    - [Actor](#actor)
    - [Goal](#goal)
  ...
  - [UC-002 – Home Assistant Automation](#uc-002--home-assistant-automation)
    - [Actor](#actor-1)
    - [Goal](#goal-1)
    ...
    - [Related Functional Requirements](#related-functional-requirements-1)
  - [UC-003 – Tesla Presence Detection](#uc-003--tesla-presence-detection)
    - [Actor](#actor-2)
    - [Goal](#goal-2)
    ...
    - [Related Functional Requirements](#related-functional-requirements-2)
  - [UC-004 – Installation through HACS](#uc-004--installation-through-hacs)
    - [Actor](#actor-3)
    - [Goal](#goal-3)
    ...
    - [Related Functional Requirements](#related-functional-requirements-3)
  - [UC-005 – Protect Vehicle](#uc-005--protect-vehicle)
    - [Actor](#actor-4)
    - [Goal](#goal-4)
    ...
    - [Related Functional Requirements](#related-functional-requirements-4)
